...
次に、タクトスイッチを中央の溝にまたがせます。4本の端子を、左側の@<tt>{e23}、@<tt>{e24}、右側の@<tt>{f23}、@<tt>{f24}へ入れてください。スイッチの端子が23行と24行に並び、溝の左右に2本ずつ分かれる向きです。タクトスイッチは、同じ側にある2本の端子が内部でつながっています。今回使うのは、スイッチの左右から1本ずつです。
