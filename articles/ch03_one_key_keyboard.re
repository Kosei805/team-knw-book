...
まず、Pico Hをブレッドボード中央の溝をまたぐように、横向きに置きます。USBコネクタが左を向く向きにしてください。
...
4端子のタクトスイッチは、向かい合う2端子がそれぞれ内部でつながっています。GP0へつなぐ端子とGNDへつなぐ端子を、スイッチの反対側の組から1本ずつ選びます。
...
電源を入れる前に、テスターがあれば、導通を確認しておくことをおすすめします。スイッチを離しているときはGP0とGNDが導通せず、押しているときだけ導通すれば、今回必要な回路になっています。
